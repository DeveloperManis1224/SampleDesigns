...
import com.app.adinn.outdoors.square_brace.adinn_outdoors.Adapters.ExpandableListAdapter;
import com.app.adinn.outdoors.square_brace.adinn_outdoors.Adapters.PlaceAdapter;
import com.app.adinn.outdoors.square_brace.adinn_outdoors.Adapters.RecentProductAdapter;
import com.app.adinn.outdoors.square_brace.adinn_outdoors.DataModel;
        ...
        if (session.getPreferences(HomeActivity.this, Constants.LOGIN_STATUS).equalsIgnoreCase(Constants.LOGOUT)) {
            ...
            FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(HomeActivity.this, new OnSuccessListener<InstanceIdResult>() {
                ...
                public void onSuccess(InstanceIdResult instanceIdResult) {
                    ...
                    Log.e("newToken", newToken);
                    tokenId = newToken;
                    uploadRefreshToken(session.getPreferences(HomeActivity.this, Constants.CURRENT_USER_ID), tokenId);
                }
            });
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (headerList.get(groupPosition).isGroup) {
                    ...
                    if (headerList.get(groupPosition).getName().equalsIgnoreCase("Home")) {
                        startActivity(new Intent(HomeActivity.this, HomeActivity.class));
                    } else if (headerList.get(groupPosition).getName().equalsIgnoreCase("Services")) {
                        startActivity(new Intent(HomeActivity.this, Services.class));
                    } else if (headerList.get(groupPosition).getName().equalsIgnoreCase("Products")) {
                        startActivity(new Intent(HomeActivity.this, PrdouctActivity.class));
                    } else if (headerList.get(groupPosition).getName().equalsIgnoreCase("My Cart")) {
                        startActivity(new Intent(HomeActivity.this, CartActivity.class));
...
//    }
    ...
    private void uploadRefreshToken(final String userId, final String tokenId) {
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "http://adinn.candyrestaurant.com/api/user-token";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String stsMessage = jsonObject.getString("message"); //LOGOUT = "0";
                            if (loginStatus.equalsIgnoreCase(Constants.RESULT_SUCCESS)) {
                                Log.e("RESPONSE-LOGIN_ERROR", loginStatus + "////" + stsMessage);
                            } else if (loginStatus.equalsIgnoreCase(Constants.RESULT_FAILED)) {
                                Toast.makeText(HomeActivity.this, "" + stsMessage,
                                        Toast.LENGTH_SHORT).show();
                            }
